  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <div className="grid min-h-screen lg:grid-cols-[1.1fr_0.9fr]">
        {/* Painel informativo: só desktop — no mobile o login ocupa a tela sozinho */}
        <section className="relative hidden overflow-hidden px-6 py-12 sm:px-10 lg:block lg:px-16">
              ...
              <div className="mb-8">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <select
                    ...
                    className="shrink-0 rounded-xl border border-slate-200 bg-slate-50 px-3 py-1.5 text-sm text-slate-700 outline-none transition focus:border-sky-400 focus:ring-4 focus:ring-sky-100"
                  >
                    {LANGUAGES.map((lang) => (
